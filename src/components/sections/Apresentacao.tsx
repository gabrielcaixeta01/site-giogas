...
function MetricCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 text-white/75">{label}</div>
    </div>
  );
}
  ...
  return (
    <section id="apresentacao" className="apresentacao py-32">
      <div className="mx-auto max-w-6xl px-4">
        ...
        {/* Diferenciais */}
        <div>
          <h3 className="text-white/95 text-3xl font-light tracking-tight mb-4">
          ...
          {[
            {
              ...
              label:
                t.apresentacao.metrics?.clientes?.label ?? "Clientes atendidos",
            },
            {
            ...
            <MetricCard key={i} value={value} label={label} />
          ))}
        </div>
        ...
        <div className="mt-10 flex justify-center">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-white text-[#175fae] px-6 py-3 font-medium shadow-lg hover:shadow-xl transition-shadow"
